...
- `logInfo(String message, Throwable cause, Object... params)`
- `logDebug(String message, Throwable cause, Object... params)`
- `logWarn(String message, Throwable cause, Object... params)`
- `logError(String message, Throwable cause, Object... params)`

**参数说明：**

- `String message`：需要日志打印的信息，可以使用`{}`占位符，配置`Object... params`使用，（不能为空）
- `Throwable cause`：异常信息，传入方法的异常信息会追加在日志信息后面，如果为空传null
- `Object... params`：日志信息参数，可以传入多个参数，参数位置应当和`message`中的`{}`位置一一对应

**使用举例：**

```java
LogUtils.logInfo("info,{},{}", new LogException(), "hello", "world");
```

日志样式：

```java
[2023-05-23 15:00:06.566][INFO ][com.example.demo.DemoApplicationTests.contextLoads][Line:14] info,hello,world
...
- `logI18NInfo(String code, Throwable cause, Object... params)`
- `logI18NDebug(String code, Throwable cause, Object... params)`
- `logI18NWarn(String code, Throwable cause, Object... params)`
- `logI18NError(String code, Throwable cause, Object... params)`

**参数说明：**

- `String code`：国际化信息代码，通过`code`获取`message`，`code`与`message`对应关系写在`i18n.properties`中
- `Throwable cause`：异常信息，传入方法的异常信息会追加在日志信息后面，如果为空传null
- `Object... params` 日志信息参数，可以传入多个参数，参数位置应当和`code`对应的`message`中的`{}`位置一一对应
...
2. 调用方法：
   ...
   ```java
   LogUtils.logI18NInfo("msg_001", new LogException(), "hello", "world");
   ```

3. 日志样式:

   ```java
   [2023-05-23 15:10:44.740][INFO ][com.example.demo.DemoApplicationTests.contextLoads][Line:20] info hello world
   ====== Exception Info Start ======
   com.eos.foundation.eoscommon.LogException
...
void test() {
    ...
    logInfo("对象：{}", new Throwable(), testPojo);
}
```
